...
public class Categories extends AppCompatActivity{
    Button signOut, create, set;
    EditText category, goal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goal = (EditText) findViewById(R.id.txtGoal);
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int gl = Integer.parseInt(goal.getText().toString().trim());
                items.setCategory(ctg);
                items.setGoal(gl);
                ref.push().setValue(items);
                Toast.makeText(Categories.this, "Category and goal have been added to database!", Toast.LENGTH_LONG).show();
            }
        });
